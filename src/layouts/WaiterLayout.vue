  ...
  <div class="waiter-layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <RouterLink to="/waiter/new-order" class="nav-item" active-class="nav-item--active">
          <span class="nav-icon">➕</span> New Order
        </RouterLink>
        <RouterLink to="/waiter/tables" class="nav-item" active-class="nav-item--active">
          <span class="nav-icon">🪑</span> Tables
        </RouterLink>
        <RouterLink to="/waiter/orders" class="nav-item" active-class="nav-item--active">
    ...
    <div class="main-wrapper">
      ...
      <nav class="bottom-nav">
        ...
        >
          ...
          <span class="bottom-nav-label">New Order</span>
        </RouterLink>
        <RouterLink
          to="/waiter/tables"
          class="bottom-nav-item"
        ...
        >
          <span class="bottom-nav-icon">🧾</span>
          <span class="bottom-nav-label">My Orders</span>
        </RouterLink>
      </nav>
    </div>
  </div>
